<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="E_Learning_System.Register" %>
            ...
            <table class="auto-style4">
                ...
                <tr>
                    ...
                    <td class="auto-style6">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="txtConfirmPassword" Display="Dynamic" ErrorMessage="*Please enter Confirm password" ForeColor="Red"></asp:RequiredFieldValidator>
                        <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtPassword" ControlToValidate="txtConfirmPassword" Display="Dynamic" ErrorMessage="*Password Mismatch" ForeColor="Red"></asp:CompareValidator>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style5">
                ...
                <tr>
                    ...
                    <td class="auto-style9">
                        ...
                        <asp:CustomValidator ID="CustomValidator2" runat="server" ClientValidationFunction="checkAggrement" Display="Dynamic" ErrorMessage="Please accept Terms &amp; Conditons first." ForeColor="Red"></asp:CustomValidator>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style8">
